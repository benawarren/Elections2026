...
#Macomb County scraper function
def scrape_macomb():
    headers = {
    ...
    current_ver_url = "https://results.enr.clarityelections.com/MI/Macomb/123849/current_ver.txt"
    ...
    print(current_ver)
    url = f"https://results.enr.clarityelections.com/MI/Macomb/123849/{current_ver}/json/en/summary.json"
    print(url)
    ...
    all_df_macomb= pd.DataFrame(rows)
    return all_df_macomb.head()
